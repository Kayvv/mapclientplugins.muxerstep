...
from mapclientplugins.muxerstep.ui_configuredialog import Ui_ConfigureDialog
...
class ConfigureDialog(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.setWhatsThis('<html>Please read the documentation available \n<a href="https://abi-mapping-tools.readthedocs.io/en/latest/mapclientplugins.muxerstep/docs/index.html">here</a> for further details.</html>')
